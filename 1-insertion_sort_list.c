...
/**
 * insertion_sort_list - sord doubly linked list of integers in ascending order
 * @list: prints a list after each swap of elements
 * Description: prints lists each time two elements are swapped
 */
